    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', models.CharField(max_length=32, verbose_name=b'Nombre')),
                ...
                ('email', models.EmailField(unique=True, max_length=254, verbose_name=b'E-mail', blank=True)),
        ...
        migrations.AddField(
            model_name='empleado',
            name='superior',
            field=models.ForeignKey(related_name='jefe', to='main.Empleado'),
        ),
        migrations.AddField(
            model_name='empleado',
            name='usuario',
